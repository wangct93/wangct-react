...
function (_DefineComponent) {
  ...
  _createClass(Form, [{
    ...
    value: function validator(value) {
      var options = this.getShowOptions();
      ...
      if (value) {
        ...
        value = this.getValue();
        value = (0, _util.aryToObject)(options, function (opt) {
          return opt.field;
        }, function (opt) {
          return value[opt.field];
        });
      }
    ...
    value: function getShowOptions() {
      ...
      return this.getShowOptions().filter(function (opt) {
        var show = opt.show;
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        style: props.style
      }, this.getShowOptions().map(function (opt) {
        var field = opt.field,
            ...
            comProps = _opt$props === void 0 ? {} : _opt$props,
            _opt$sep = opt.sep,
            sep = _opt$sep === void 0 ? props.sep : _opt$sep;
        ...
        var disabled = comProps.disabled || opt.disabled || readOnly;
        var params = opt.parent ? (0, _util.aryToObject)((0, _arrayUtil.toAry)(opt.parent), function (field) {
          return field;
        }, function (field) {
          return value[field];
        }) : null;
        var comParams = comProps.params ? _objectSpread({}, comProps.params, {}, params) : params;
        var title = opt.title;
...
function (_PureComponent) {
  ...
  _createClass(FormItem, [{
    ...
    value: function render() {
      ...
      }, "*"), _react["default"].createElement("span", null, props.title, _react["default"].createElement("span", {
        className: "w-form-sep"
      }, props.sep === false ? '' : props.sep || '：'))), _react["default"].createElement("div", {
