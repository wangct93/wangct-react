...
function (_DefineComponent) {
  _inherits(Input, _DefineComponent);
  ...
  function Input() {
    ...
    _this.state = {
      placeholder: '请输入' + (0, _stringUtil.toStr)(_this.props.title),
      allowClear: true
    };

    _this.inputChange = function (e) {
      _this.onChange(e.target.value || undefined);
    };

    _this.keydown = function (e) {
      if (e.keyCode === 13) {
        (0, _util.callFunc)(_this.props.onSearch, _this.getValue());
      }
    };
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      return _react["default"].createElement(_baseCom.AntInput, _extends({
        ref: this.setElem
      }, this.getProps(), {
